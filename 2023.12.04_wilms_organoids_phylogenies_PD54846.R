...
patient <- 'PD54846' # can code this so can come in from the command line
...
tum_orgs <- samps
# there are no clonal normal samples. tum_orgs <- samps
normals <- c("PD54846m") 
...
hist(filtmat$tumour_dep, 100, xlim=c(0, 1500))
...
filtmat$cov_in_tumour[(grepl('X|Y',filtmat$mutkey)) & filtmat$tumour_dep>250 & filtmat$tumour_dep<500] <- 'good'
